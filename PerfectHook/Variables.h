...
struct Variables
{
	...
	struct Antiaim {
		...
		int Fakewalk = 0;
		int Freestanding = 0;
		int FreestandingDelta = 0; int AtPlayer = 0;
	...
	struct 
	{
		...
		bool enemy_beams;
		float beam_time = 3.f;
		bool skycolorchanger;
		bool worldcolorchanger;
		bool bulletstracers;
		float timebullets = 1.f;
		bool GhostChams;
		int GhostChamsMode;
		float GhostChamsColor[3] = { 1.0f, 1.0f, 1.0f };
	} Visuals;
	...
	struct
	{
		...
		float EnemyGlow[3] = { 0.23921f, 0.55294f, 0.89019f };
		float TeamGlow[3] = { 0.89019f, 0.23137f, 0.23137f };
		float inEnemyGlow[3] = { 1.0f, 0.55294f, 0.89019f };
		float inTeamGlow[3] = { 0.89019f, 1.0f, 0.23137f };
		...
		float hands_alpha; 
		float tracer_color[4] = { 1.f, 0, 0, 1.f };
		...
		float beam[3] = { 1.f, 0.f , 0.f};
		float colorchanger[3] = { 1.f, 0, 0 };
		float wcolorchanger[3] = { 1.f, 0, 0 };
		float bullets[3] = { 1.f, 0, 0 };
		float Weaponalpha = 0.6f;
		float Glowalpha = 0.7f;
		float healthboard[4] = { 1.0f, 0, 0, 1.0f };
		float healthpline[4] = { 0, 1.0f, 0, 1.0f };
		float colornamexd[4] = { 0, 0, 0, 1.0f };
		float moneycolorxd[4] = { 1.0f, 0, 0, 1.0f };
		float defuserxd[4] = { 1.0f, 0, 0, 1.0f };
		float skopedxd[4] = { 1.0f, 0, 1.0f, 1.0f };
		float flashedxd[4] = { 1.0f, 1.0f, 1.0f, 1.0f };
		float timexd[4] = { 1.0f, 1.0f, 1.0f, 1.0f };
		float frenadexd[4] = { 1.0f, 0, 0, 1.0f };
		float dropwepnamexd[4] = { 1.0f, 0, 0, 1.0f };
		float bombxd[4] = { 1.0f, 1.0f, 1.0f, 1.0f };
		float snaplinexd[4] = { 1.0f, 1.0f, 1.0f, 1.0f };
		float boxvisiblect[4] = { 0, 0, 1.0f, 1.0f };
		float boxvisiblet[4] = { 0, 1.0f, 0, 1.0f };
