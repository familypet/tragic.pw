		...
		{													//1040		//613
			...
			*/
			...
			ImGui::BeginChild("##tabshit", ImVec2(100.f, 580.f)); //100 580 lef
			{
				...
				if (ImGui::Button("A", ImVec2(100, 76.5))) //legitbot
					tabselected = 1;
				if (ImGui::Button("I", ImVec2(100, 76.5))) //visuals
					tabselected = 2;
				if (ImGui::Button("D", ImVec2(100, 76.5)))  //misc
					tabselected = 3;
				if (ImGui::Button("G", ImVec2(100, 76.5))) //skinchanger
					tabselected = 4;
				if (ImGui::Button("B", ImVec2(100, 78.5))) //skinchanger
					tabselected = 5;
...

					{
						...
						ImGui::BeginChild("##esppage1", ImVec2(310, 545), true);
						{
							...
							ImGui::Spacing();
							{
								...
								ImGui::SameLine(267);
								ImGui::MyColorEdit3(XorStr(""), (float*)&g_Options.Colors.box_color_ct, 1 << 7);
...
\
								...
								ImGui::BeginChild("##esppage2", ImVec2(310, 545), true);
								{
									...
									ImGui::Spacing();
									{
										...
										ImGui::SliderFloat(("View model"), &g_Options.Visuals.viewmodelChanger, 0.f, 120.f, "%.0f");
...

					{
						...
						ImGui::BeginChild("##miscpage1", ImVec2(310, 545), true);
						{
							...
							ImGui::Spacing();
							{
								...
								ImGui::Checkbox(("Damage Log"), &g_Options.Misc.eventlogs);
								ImGui::Checkbox(("Purchase Log"), &g_Options.Misc.eventlogs2);;
								...
								ImGui::Checkbox(XorStr("Rank Revealer"), &g_Options.Misc.ServerRankRevealAll);
							...
							ImGui::Text("Bhop Styles");
							ImGui::Combo("", &g_Options.Misc.Bhop, bhopstyles, ARRAYSIZE(bhopstyles));
				...
				else if (tabselected == 0)
				{
					...
					ImGui::BeginChild("Changelog", ImVec2(660, 575), true);
					{
						...
						ImGui::Text(XorStr("Current version: 3.2"));
						ImGui::Text(XorStr("Build date: 23/05/2018"));
