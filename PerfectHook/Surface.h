...
public:
	...
	void SetDrawColorgg(int r, int g, int b, int a)
	{
		typedef void(__thiscall* Fn)(void*, int, int, int, int);
		return call_vfunc<Fn>(this, 15)(this, r, g, b, a);
	}
	void SetDrawColor(Color color)
	{
		//typedef void(__thiscall* Fn)(PVOID, Color); // int, int , int, int
		//return CallVFunction<Fn>(this, 14)(this, color); // r, g, b, a
		SetDrawColorgg(color.r(), color.g(), color.b(), color.a());
	}
	inline void un_lock_cursor()
	{
		typedef void(__thiscall* original_fn)(void*);
		call_vfunc< original_fn >(this, 67)(this);
	}
	void DrawPrintTextHELP(const wchar_t* Text, int Len, int DrawType = 0) {
