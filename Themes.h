...
void RenderDefault(IDirect3DDevice9* pDevice)
{
	...
	//CaviarDreams = io.Fonts->AddFontFromMemoryCompressedTTF(CaviarDreams, 5084, 18.f);
	...
	style.Colors[ImGuiCol_ScrollbarBg] = ImVec4(0.255f, 0.255f, 0.255f, 0.50f);
	style.Colors[ImGuiCol_ScrollbarGrab] = ImVec4(1.255f, 1.255f, 1.255f, 0.44f);
	style.Colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4(1.255f, 1.255f, 1.255f, 0.74f);
	style.Colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(1.255f, 1.255f, 1.255f, 10.00f);
	...
	style.Colors[ImGuiCol_SliderGrab] = ImVec4(0.255f, 0.255, 0.255, 0);
	style.Colors[ImGuiCol_SliderGrabActive] = ImVec4(0.255, 0.255, 0.255, 0);

	//style.Colors[ImGuiCol_SliderGrab] = ImVec4(0.255f, 0.250f, 0.250f, 1.f);
	//style.Colors[ImGuiCol_SliderGrabActive] = ImVec4(0.255f, 0.250f, 0.250f, 1.f);
